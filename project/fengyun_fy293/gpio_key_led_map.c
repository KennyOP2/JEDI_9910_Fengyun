...
#define BUTTON_CTRL_Record     46 // 27  kenny
#define BUTTON_CTRL_SrcSel     47 //GPIO47
#define BUTTON_CTRL_ResSel     47 //GPIO44
#define BUTTON_CTRL_StorageSel   45 //GPIO45
    ...
    void)
{
	...
	GPIO_SetState(BUTTON_CTRL_StorageSel, GPIO_STATE_LO);  	    
       //Set GPIO Output Mode
	GPIO_SetMode(BUTTON_CTRL_StorageSel, GPIO_MODE_OUTPUT);
	//Set GPIO Mode0	
	ithGpioSetMode(BUTTON_CTRL_StorageSel, ITH_GPIO_MODE0);
...
if(status)
{
 GPIO_SetState(BUTTON_CTRL_StorageSel, GPIO_STATE_HI);  
