...
#define BUTTON_CTRL_SrcSel     46 //GPIO47
#define BUTTON_CTRL_ResSel     46 //GPIO44
#define BUTTON_CTRL_StorageSel 46 //GPIO45
...
GpioLEDInitialize(
    void)
{
    gtLEDCtrl.gpioLed_Analog = 32;   //31;
    gtLEDCtrl.gpioLed_HDMI   = 47;   // 32;
    gtLEDCtrl.gpioLed_720P   = 29;   //29;
    gtLEDCtrl.gpioLed_1080P  = 23;   //23;
