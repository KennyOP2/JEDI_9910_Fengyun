...
#if (PROJECT_TYPE == fengyun_fy281) || (PROJECT_TYPE == fengyun_fy283) || (PROJECT_TYPE == fengyun_fy286)
                reg_write16(REG_IIS_IO_SET, 0x3308);
#else
                reg_write16(REG_IIS_IO_SET, 0x2208);        //kenny 20141106
#endif
            else
