...
{
#if 1 //for SONY TV
	{CEA_720x480i60, 6, {0xb9, 0x1a, 0x87, 0x57, 0x30, 0x0F, 0x4D, 0x00,	 0x0d,0x02, 	 0x0E, 0xFE, 0x00, 0x15, 0x05, 0x21,	 0x0A, 0xf0, 0x10, 0x51, 0xf0, 0x00, 0x10,}},
	{CEA_720x576i50,21,{ 0xe9, 0x1a, 0x8D, 0x5D, 0x30, 0x08, 0x47, 0x00,   0x71,0x02,	   0x12, 0x32, 0x10, 0x4B, 0x6B, 0x21,		0x0A, 0xF0, 0x43, 0x81,0xf0,0x00,0x40}},
    {CEA_1920x1080i50, 20, {0xaf, 0x44, 0xe2, 0x62, 0x80, 0x02, 0x2e, 0x00,      0x60, 0x04,         0x13, 0x2f, 0x20, 0x46, 0x62, 0x42,        0x0a, 0xf0, 0x3d, 0x22, 0x30, 0x00, 0x40, }},
    {CEA_1920x1080i60, 5, {0xaf, 0x44, 0xe2, 0x62, 0x80, 0x02, 0x2e, 0x00,    0x64, 0x04,           0x13, 0x2f, 0x20, 0x46, 0x62, 0x42,          0x0a, 0xf0, 0x3d, 0x22, 0x30, 0x00, 0x40, }},
#else
...
void SetTxDEGenYPbPr(MODE_ID id)
{
	BYTE TxCEAFmt = 0x0;
    BYTE caseFound = 0;
    BYTE i,off;

    printf("SetTxDEGenYPbPr - mode %d\n",id);
